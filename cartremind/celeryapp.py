...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "cartremind.config")
os.environ.setdefault("DJANGO_CONFIGURATION", "Production")
#os.environ.setdefault("DJANGO_SETTINGS_MODULE", "cartremind.config.production")
