web: bin/start-nginx bin/start-pgbouncer-stunnel newrelic-admin run-program gunicorn -c gunicorn.conf --pythonpath="$PWD/trackosaurus" wsgi:application --logfile=-
